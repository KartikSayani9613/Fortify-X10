 ...
 * </p>
 * <ul>
 *   <li>{@link srf.transpiler.fortxtrans.fortXTrans.impl.LiteralListImpl#getLit <em>Lit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralListImpl extends LiteralTupImpl implements LiteralList
{
  /**
  ...
  {
    return FortXTransPackage.Literals.LITERAL_LIST;
  }
  ...
  public EList<Literal> getLit()
  {
    if (lit == null)
    {
      lit = new EObjectContainmentEList<Literal>(Literal.class, this, FortXTransPackage.LITERAL_LIST__LIT);
    }
    return lit;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FortXTransPackage.LITERAL_LIST__LIT:
