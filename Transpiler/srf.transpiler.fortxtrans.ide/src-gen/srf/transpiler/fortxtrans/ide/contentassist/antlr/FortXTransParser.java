		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLiteralAccess().getAlternatives_3_1(), "rule__Literal__Alternatives_3_1");
					...
					put(grammarAccess.getQualifiedNameTupleAccess().getGroup_1(), "rule__QualifiedNameTuple__Group_1__0");
					...
					put(grammarAccess.getStmntsAccess().getGroup_1(), "rule__Stmnts__Group_1__0");
					put(grammarAccess.getStmntListAccess().getGroup(), "rule__StmntList__Group__0");
					put(grammarAccess.getStmntListAccess().getGroup_1(), "rule__StmntList__Group_1__0");
					...
					put(grammarAccess.getFieldDeclAccess().getGroup_0_3(), "rule__FieldDecl__Group_0_3__0");
					...
					put(grammarAccess.getFieldDeclAccess().getGroup_2_6(), "rule__FieldDecl__Group_2_6__0");
					put(grammarAccess.getFieldDeclAccess().getGroup_3(), "rule__FieldDecl__Group_3__0");
					put(grammarAccess.getFieldDeclAccess().getGroup_3_5(), "rule__FieldDecl__Group_3_5__0");
					put(grammarAccess.getNoNewlineVarWTypesAccess().getGroup_0(), "rule__NoNewlineVarWTypes__Group_0__0");
					put(grammarAccess.getNoNewlineVarWTypesAccess().getGroup_0_1(), "rule__NoNewlineVarWTypes__Group_0_1__0");
					...
					put(grammarAccess.getLiteralTupAccess().getGroup_1(), "rule__LiteralTup__Group_1__0");
					...
					put(grammarAccess.getQualifiedNameAccess().getSAssignment_0(), "rule__QualifiedName__SAssignment_0");
					put(grammarAccess.getQualifiedNameAccess().getSAssignment_1_1(), "rule__QualifiedName__SAssignment_1_1");
					put(grammarAccess.getQualifiedNameAccess().getDotsAssignment_2(), "rule__QualifiedName__DotsAssignment_2");
					put(grammarAccess.getQualifiedNameTupleAccess().getQlistAssignment_0(), "rule__QualifiedNameTuple__QlistAssignment_0");
					put(grammarAccess.getQualifiedNameTupleAccess().getQlistAssignment_1_1(), "rule__QualifiedNameTuple__QlistAssignment_1_1");
					...
					put(grammarAccess.getParamAccess().getParIdAssignment_0(), "rule__Param__ParIdAssignment_0");
					...
					put(grammarAccess.getStmntsAccess().getDelimsAssignment_1_2(), "rule__Stmnts__DelimsAssignment_1_2");
					put(grammarAccess.getStmntsAccess().getLocVarAssignment_2(), "rule__Stmnts__LocVarAssignment_2");
					put(grammarAccess.getStmntsAccess().getExpAssignment_3(), "rule__Stmnts__ExpAssignment_3");
					put(grammarAccess.getStmntAccess().getDelimAssignment(), "rule__Stmnt__DelimAssignment");
					put(grammarAccess.getStmntListAccess().getDelimAssignment_0(), "rule__StmntList__DelimAssignment_0");
					put(grammarAccess.getStmntListAccess().getDelimAssignment_1_1(), "rule__StmntList__DelimAssignment_1_1");
					...
					put(grammarAccess.getExponentExprAccess().getOpAssignment_1_1(), "rule__ExponentExpr__OpAssignment_1_1");
					...
					put(grammarAccess.getPrimaryAccess().getTypeAssignment_0_3_3(), "rule__Primary__TypeAssignment_0_3_3");
					put(grammarAccess.getPrimaryAccess().getSizesAssignment_0_3_5(), "rule__Primary__SizesAssignment_0_3_5");
					put(grammarAccess.getPrimaryAccess().getFillerAssignment_0_3_9(), "rule__Primary__FillerAssignment_0_3_9");
					...
					put(grammarAccess.getPrimaryAccess().getExpAssignment_3_2(), "rule__Primary__ExpAssignment_3_2");
					...
					put(grammarAccess.getFieldDeclAccess().getInitAssignment_0_3_1(), "rule__FieldDecl__InitAssignment_0_3_1");
					...
					put(grammarAccess.getFieldDeclAccess().getInitAssignment_1_3(), "rule__FieldDecl__InitAssignment_1_3");
					...
					put(grammarAccess.getFieldDeclAccess().getInitAssignment_2_6_1(), "rule__FieldDecl__InitAssignment_2_6_1");
					...
					put(grammarAccess.getFieldDeclAccess().getInitAssignment_3_5_1(), "rule__FieldDecl__InitAssignment_3_5_1");
					put(grammarAccess.getNoNewlineVarWTypesAccess().getSingleAssignment_0_0(), "rule__NoNewlineVarWTypes__SingleAssignment_0_0");
					put(grammarAccess.getNoNewlineVarWTypesAccess().getArrsizeAssignment_0_1_1(), "rule__NoNewlineVarWTypes__ArrsizeAssignment_0_1_1");
					...
					put(grammarAccess.getLiteralListAccess().getLitAssignment_0(), "rule__LiteralList__LitAssignment_0");
					put(grammarAccess.getLiteralListAccess().getLitAssignment_1_1(), "rule__LiteralList__LitAssignment_1_1");
					...
					put(grammarAccess.getLiteralAccess().getValueAssignment_3_1_0(), "rule__Literal__ValueAssignment_3_1_0");
					put(grammarAccess.getLiteralAccess().getValueAssignment_3_1_1(), "rule__Literal__ValueAssignment_3_1_1");
					...
					put(grammarAccess.getLocalVarDeclAccess().getInitAssignment_1_2(), "rule__LocalVarDecl__InitAssignment_1_2");
