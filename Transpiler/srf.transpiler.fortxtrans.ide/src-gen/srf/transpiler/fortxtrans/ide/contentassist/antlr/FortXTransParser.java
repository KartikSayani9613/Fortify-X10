		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExprAccess().getLitAssignment_2(), "rule__Expr__LitAssignment_2");
					...
					put(grammarAccess.getDelimitedExprAccess().getParAssignment_6(), "rule__DelimitedExpr__ParAssignment_6");
					put(grammarAccess.getDelimitedExprAccess().getParblockAssignment_7_1(), "rule__DelimitedExpr__ParblockAssignment_7_1");
