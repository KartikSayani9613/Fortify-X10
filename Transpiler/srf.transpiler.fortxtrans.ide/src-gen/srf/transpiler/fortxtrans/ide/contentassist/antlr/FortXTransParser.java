		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocalVarDeclAccess().getAlternatives_0_2(), "rule__LocalVarDecl__Alternatives_0_2");
					put(grammarAccess.getLocalVarDeclAccess().getAlternatives_2_5(), "rule__LocalVarDecl__Alternatives_2_5");
					put(grammarAccess.getLocalVarDeclAccess().getAlternatives_3_4(), "rule__LocalVarDecl__Alternatives_3_4");
					...
					put(grammarAccess.getStmntAccess().getGroup_0(), "rule__Stmnt__Group_0__0");
					...
					put(grammarAccess.getDelimitedExprAccess().getGroup_6(), "rule__DelimitedExpr__Group_6__0");
					put(grammarAccess.getDelimitedExprAccess().getGroup_7(), "rule__DelimitedExpr__Group_7__0");
					...
					put(grammarAccess.getStmntAccess().getFrontAssignment_0_0(), "rule__Stmnt__FrontAssignment_0_0");
					put(grammarAccess.getStmntAccess().getTailsAssignment_0_1(), "rule__Stmnt__TailsAssignment_0_1");
					put(grammarAccess.getStmntAccess().getLocVarAssignment_1(), "rule__Stmnt__LocVarAssignment_1");
					put(grammarAccess.getStmntAccess().getExpAssignment_2(), "rule__Stmnt__ExpAssignment_2");
					put(grammarAccess.getExprAccess().getLitAssignment(), "rule__Expr__LitAssignment");
					put(grammarAccess.getExprFrontAccess().getDelimAssignment(), "rule__ExprFront__DelimAssignment");
					...
					put(grammarAccess.getDelimitedExprAccess().getLitsAssignment_1_0(), "rule__DelimitedExpr__LitsAssignment_1_0");
					put(grammarAccess.getDelimitedExprAccess().getEqopAssignment_1_1(), "rule__DelimitedExpr__EqopAssignment_1_1");
					put(grammarAccess.getDelimitedExprAccess().getPblockAssignment_1_2(), "rule__DelimitedExpr__PblockAssignment_1_2");
					put(grammarAccess.getDelimitedExprAccess().getRetAssignment_2_0(), "rule__DelimitedExpr__RetAssignment_2_0");
					put(grammarAccess.getDelimitedExprAccess().getBlockAssignment_2_1(), "rule__DelimitedExpr__BlockAssignment_2_1");
					put(grammarAccess.getDelimitedExprAccess().getAwhileAssignment_3_0(), "rule__DelimitedExpr__AwhileAssignment_3_0");
					put(grammarAccess.getDelimitedExprAccess().getExprAssignment_3_1(), "rule__DelimitedExpr__ExprAssignment_3_1");
					put(grammarAccess.getDelimitedExprAccess().getWhiledodAssignment_3_2(), "rule__DelimitedExpr__WhiledodAssignment_3_2");
					put(grammarAccess.getDelimitedExprAccess().getAforAssignment_4_0(), "rule__DelimitedExpr__AforAssignment_4_0");
					put(grammarAccess.getDelimitedExprAccess().getGenAssignment_4_1(), "rule__DelimitedExpr__GenAssignment_4_1");
					put(grammarAccess.getDelimitedExprAccess().getDofrontAssignment_4_2(), "rule__DelimitedExpr__DofrontAssignment_4_2");
					put(grammarAccess.getDelimitedExprAccess().getAnifAssignment_5_0(), "rule__DelimitedExpr__AnifAssignment_5_0");
					put(grammarAccess.getDelimitedExprAccess().getCondAssignment_5_1(), "rule__DelimitedExpr__CondAssignment_5_1");
					put(grammarAccess.getDelimitedExprAccess().getBlocksAssignment_5_3(), "rule__DelimitedExpr__BlocksAssignment_5_3");
					put(grammarAccess.getDelimitedExprAccess().getElifsAssignment_5_4(), "rule__DelimitedExpr__ElifsAssignment_5_4");
					put(grammarAccess.getDelimitedExprAccess().getElsAssignment_5_5(), "rule__DelimitedExpr__ElsAssignment_5_5");
					put(grammarAccess.getDelimitedExprAccess().getParblockAssignment_6_1(), "rule__DelimitedExpr__ParblockAssignment_6_1");
					put(grammarAccess.getDelimitedExprAccess().getFnameAssignment_7_0(), "rule__DelimitedExpr__FnameAssignment_7_0");
					put(grammarAccess.getDelimitedExprAccess().getBrackAssignment_7_1(), "rule__DelimitedExpr__BrackAssignment_7_1");
					put(grammarAccess.getDelimitedExprAccess().getFargsAssignment_7_2(), "rule__DelimitedExpr__FargsAssignment_7_2");
					put(grammarAccess.getExprListAccess().getExpAssignment_0(), "rule__ExprList__ExpAssignment_0");
					put(grammarAccess.getExprListAccess().getExpAssignment_1_1(), "rule__ExprList__ExpAssignment_1_1");
					put(grammarAccess.getParBlockElemsAccess().getBrackAssignment_0(), "rule__ParBlockElems__BrackAssignment_0");
					...
					put(grammarAccess.getLocalVarDeclAccess().getMutaAssignment_0_2_0(), "rule__LocalVarDecl__MutaAssignment_0_2_0");
					put(grammarAccess.getLocalVarDeclAccess().getImmutAssignment_0_2_1(), "rule__LocalVarDecl__ImmutAssignment_0_2_1");
					...
					put(grammarAccess.getLocalVarDeclAccess().getMutaAssignment_2_5_0(), "rule__LocalVarDecl__MutaAssignment_2_5_0");
					put(grammarAccess.getLocalVarDeclAccess().getImmutAssignment_2_5_1(), "rule__LocalVarDecl__ImmutAssignment_2_5_1");
					...
					put(grammarAccess.getLocalVarDeclAccess().getMutaAssignment_3_4_0(), "rule__LocalVarDecl__MutaAssignment_3_4_0");
					put(grammarAccess.getLocalVarDeclAccess().getImmutAssignment_3_4_1(), "rule__LocalVarDecl__ImmutAssignment_3_4_1");
