		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStmntAccess().getDelimsAssignment_1_1(), "rule__Stmnt__DelimsAssignment_1_1");
					...
					put(grammarAccess.getPrimaryAccess().getExpAssignment_2_2(), "rule__Primary__ExpAssignment_2_2");
