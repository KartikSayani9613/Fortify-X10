		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAbsFnModAccess().getAlternatives(), "rule__AbsFnMod__Alternatives");
					put(grammarAccess.getLocalFnModAccess().getAlternatives(), "rule__LocalFnMod__Alternatives");
					...
					put(grammarAccess.getFnDeclAccess().getFnNameAssignment_1(), "rule__FnDecl__FnNameAssignment_1");
					put(grammarAccess.getFnDeclAccess().getParamsAssignment_2(), "rule__FnDecl__ParamsAssignment_2");
					put(grammarAccess.getFnDeclAccess().getReturnAssignment_4(), "rule__FnDecl__ReturnAssignment_4");
					...
					put(grammarAccess.getFnModAccess().getAbsModAssignment_0(), "rule__FnMod__AbsModAssignment_0");
					put(grammarAccess.getFnModAccess().getPriAssignment_1(), "rule__FnMod__PriAssignment_1");
					put(grammarAccess.getAbsFnModAccess().getLocalAssignment_0(), "rule__AbsFnMod__LocalAssignment_0");
					put(grammarAccess.getAbsFnModAccess().getTestAssignment_1(), "rule__AbsFnMod__TestAssignment_1");
					put(grammarAccess.getValParamAccess().getBindIDAssignment_0(), "rule__ValParam__BindIDAssignment_0");
