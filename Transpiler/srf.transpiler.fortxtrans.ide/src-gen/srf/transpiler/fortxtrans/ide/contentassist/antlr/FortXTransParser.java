		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDelimitedExprAccess().getDoAssignment_0(), "rule__DelimitedExpr__DoAssignment_0");
					put(grammarAccess.getDelimitedExprAccess().getExprAssignment_1_1(), "rule__DelimitedExpr__ExprAssignment_1_1");
					put(grammarAccess.getDelimitedExprAccess().getDoAssignment_1_2(), "rule__DelimitedExpr__DoAssignment_1_2");
					put(grammarAccess.getDelimitedExprAccess().getGenAssignment_2_1(), "rule__DelimitedExpr__GenAssignment_2_1");
					put(grammarAccess.getDelimitedExprAccess().getDorontAssignment_2_2(), "rule__DelimitedExpr__DorontAssignment_2_2");
					...
					put(grammarAccess.getBlockElemsAccess().getMoreBlocksAssignment_2(), "rule__BlockElems__MoreBlocksAssignment_2");
					...
					put(grammarAccess.getDoFrontAccess().getAtAssignment_0(), "rule__DoFront__AtAssignment_0");
